...
class monitor:
    ...
    def print_info(self,idx):
        ...
        print("## State Change occur in %s ##" %str(now.time()))
        print("########################################### \n") 

        print("########################")
        print("## length : %s " %str(int(self.status[0])))
        print("## ac_info : %s " %self.status[1])
        print("## Book : %s " %self.status[2])
        print("## count : %s " %str(self.status[3]))
        print("## sceinaro : %s " %str(self.status[4]))
        print("######################## \n\n\n")
